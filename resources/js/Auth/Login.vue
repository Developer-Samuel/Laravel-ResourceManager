                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" v-model="form.remember" name="remember" id="remember" aria-describedby="remember" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800">
                                </div>
...
export default {
    ...
    mounted() {
        ...
        if (successMessage) {
            this.$refs.alerts.showAlert(successMessage, 'success');
        }
    },
    methods: {
        submitForm() {
            axios.post('/login/store', this.form)
                .then((response) => {
